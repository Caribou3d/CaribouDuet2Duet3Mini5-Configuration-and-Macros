...
; =========================================================================================================
;
;G31 Z0.99                                       ; BuildTak sheet and SE vanadium nozzle
M500 P10:31                                     ; save settings to config-overide.g - G31 P31 saves trigger height
M290 R0 S0                                      ; set babystep to 0mm absolute
;
M291 P{"Settings for BuildTak sheet and SE vanadium nozzle. Set probe offset to " ^ sensors.probes[0].triggerHeight  } S2
;
; =========================================================================================================
;
